...
import com.etiya.replaylab.model.ReplayLabEvidenceSnapshot;
...
class RovoSnapshotPublisherServiceTest {
    ...
    void shouldNotContainLegacyWikiMarkup() throws Exception {
        ...
        ReplayLabEvidenceSnapshot snapshot = createTestSnapshot();
    ...
    void shouldHaveExtractableAndParsableJson() throws Exception {
        ...
        assertDoesNotThrow(() -> {
            ReplayLabEvidenceSnapshot parsed = objectMapper.readValue(extractedJson, ReplayLabEvidenceSnapshot.class);
    ...
    private ReplayLabEvidenceSnapshot createTestSnapshot() {
        return new ReplayLabEvidenceSnapshot(
                ...
                null, // evidenceIds
                new ReplayLabEvidenceSnapshot.GuardrailsInfo(
                        true, // evidenceOnly
