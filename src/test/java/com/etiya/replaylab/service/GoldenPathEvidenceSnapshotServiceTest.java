...
import com.etiya.replaylab.api.dto.GoldenPathEvidenceSnapshotJiraPreviewResponse;
import com.etiya.replaylab.api.dto.GoldenPathEvidenceSnapshotResponse;
...
class GoldenPathEvidenceSnapshotServiceTest {
    ...
    void snapshotIsReadyWhenCanonicalEvidenceExists() {
        ...
        assertThat(response.aiInputBundle().source())
                .isEqualTo("replaylab-ai-bundle-builder");
    }
    ...
    private List<EvidenceEntity> canonicalEvidence(
        ...
        values.add(evidence(
                ...
                "{\"bundleVersion\":\"replaylab-ai-bundle-v1\",\"includedEvidence\":[\"JENKINS_BUILD_CONTEXT\"]}"
        ));
        values.add(evidence(
                EvidenceType.DETERMINISTIC_ROOT_CAUSE,
