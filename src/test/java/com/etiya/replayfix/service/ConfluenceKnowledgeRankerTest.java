...
import com.etiya.replayfix.model.ConfluenceSearchHit;
...
class ConfluenceKnowledgeRankerTest {
    ...
    void testJiraKeyTitleMatch() {
        ...
        assertTrue(ranked.get(0).replayFixScore() > 100);
    ...
    void testApplicationMatch() {
        ...
        assertFalse(ranked.isEmpty());
        assertTrue(ranked.get(0).replayFixScore() >= 80);
    }
    ...
    void testRecentPageBonus() {
        ...
        assertFalse(ranked.isEmpty());
        assertTrue(ranked.get(0).replayFixScore() > 0);
    }
    ...
    void testScoreOrdering() {
        ...
        assertTrue(ranked.get(0).replayFixScore() > ranked.get(1).replayFixScore());
    }
}
