...
class JiraWebhookSecurityValidatorTest {
    ...
    void setUp() {
        ...
        ReplayFixProperties.Integrations integrations = new ReplayFixProperties.Integrations();
        ReplayFixProperties.JiraWebhookEndpoint webhook = new ReplayFixProperties.JiraWebhookEndpoint();
