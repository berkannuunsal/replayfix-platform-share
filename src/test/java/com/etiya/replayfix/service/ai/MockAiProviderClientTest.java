...
class MockAiProviderClientTest {
    ...
    void setUp() {
        ...
        ReplayFixProperties.Ai aiConfig = new ReplayFixProperties.Ai();
        aiConfig.setEnabled(true);
        aiConfig.setProvider(AiProviderType.MOCK);
        aiConfig.setModel("mock-replayfix-v1");
    ...
    void testConnectivity_ReturnsSuccess() {
        ...
        assertThat(result.model()).isEqualTo("mock-replayfix-v1");
    ...
    void testGenerate_ConfidenceCapped() {
        ...
        AiGenerationRequest request = new AiGenerationRequest(
                caseId, "FULL_INCIDENT_ANALYSIS", "", "", "mock-replayfix-v1", 0.1, 30000, true, Map.of()
        );
