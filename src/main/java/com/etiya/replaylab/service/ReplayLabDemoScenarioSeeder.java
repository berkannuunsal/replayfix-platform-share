...
public class ReplayLabDemoScenarioSeeder {

    private static final Logger log = LoggerFactory.getLogger(ReplayLabDemoScenarioSeeder.class);
    ...
    public ReplayLabDemoScenarioSeeder(
    ...
    public DemoScenarioResult seedHttp401Scenario() {
        ...
        String dashboardUrl = "/replaylab/?caseId=" + caseEntity.getId() + "&presentation=true";
    ...
    private String resolveDemoTargetKey() {
        Map<String, ReplayLabProperties.Target> targets = properties.getTargets();
        
        if (targets == null || targets.isEmpty()) {
            String errorMsg = "Demo scenario requires at least one configured target in replaylab.targets. " +
