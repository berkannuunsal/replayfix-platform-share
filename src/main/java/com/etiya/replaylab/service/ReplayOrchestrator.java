...
import com.etiya.replaylab.api.dto.StepResponse;
...
import com.etiya.replaylab.integration.*;
...
public class ReplayOrchestrator {
    ...
    public StepResponse collectContext(UUID id) {
        ...
        try {
            ...
            evidenceService.save(
                    ...
                    "replaylab-correlation-extractor",
            ...
            evidenceService.save(
                    ...
                    "replaylab-deterministic-analysis",
                    objectMapper.writeValueAsString(
                            deterministicReport
                    ),
                    true
    ...
    public StepResponse generatePatch(UUID id) {
        if (!properties.getPolicy().isAllowGeneratedCodeWrite()
                && properties.getMode() == ReplayLabProperties.Mode.LIVE) {
            caseService.updateStatus(
                    id,
    ...
    public StepResponse publishAndValidate(UUID id) {
        ...
        try {
            ...
            if (properties.getPolicy().isAllowPullRequestCreation()
                    || properties.getMode() == ReplayLabProperties.Mode.DRY_RUN) {
    ...
    private ReplayLabProperties.Target target(
