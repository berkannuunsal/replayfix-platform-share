...
public class PrRuleReviewService {
    ...
    private RuleLoadResult loadRules(
        ...
        ReplayLabProperties.SourceCandidateBitbucket bitbucket = bitbucketConfig();
    ...
    private ReplayLabProperties.SourceCandidateBitbucket bitbucketConfig() {
        ReplayLabProperties.SourceCandidateBitbucket bitbucket =
                new ReplayLabProperties.SourceCandidateBitbucket();
        ReplayLabProperties.Bitbucket configured =
    ...
    private ReplayLabProperties.SourceCandidateRepository repositoryConfig(
            String repositoryType,
            PrRuleReviewRequest request
    ) {
        ReplayLabProperties.SourceCandidateRepository repository =
    ...
    private String configuredDefaultBranch(
        ...
        return properties.getTargets().values().stream()
                ...
                .map(ReplayLabProperties.SourceCandidateRepository::getBranch)
