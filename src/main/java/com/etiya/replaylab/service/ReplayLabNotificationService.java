...
import com.etiya.replaylab.model.NotificationCommand;
import com.etiya.replaylab.model.NotificationView;
...
@Service
public class ReplayLabNotificationService {

    private static final Logger log = LoggerFactory.getLogger(ReplayLabNotificationService.class);

    private final NotificationRepository notificationRepository;
    private final EvidenceSanitizer sanitizer;
    private final OutboundWebhookNotificationClient webhookClient;

    public ReplayLabNotificationService(
    ...
    public void notifyWorkflowCompleted(WorkflowRunEntity workflow, ReplayCaseEntity caseEntity) {
        ...
        String targetUrl = "/replaylab/?caseId=" + caseEntity.getId();
    ...
    public void notifyJiraCommentPublished(UUID caseId, String jiraKey) {
        String targetUrl = "/replaylab/?caseId=" + caseId;
    ...
    private String validateTargetUrl(String url) {
        ...
        if (url.startsWith("/replaylab/")) return url;
